...
def listar_livros(nome_livro:str):
    for biblioteca in bibliotecas:
        if biblioteca.nome == nome_livro:
            return biblioteca.acervo
    raise HTTPException(404,"não localizado")  
 
@app.get("/livros/{titulo}",response_model=Livro)
def listar_livros(nome_livro:str, titulo:str):
    for biblioteca in bibliotecas:
        if biblioteca.nome == nome_livro:
...
def deletar_livro(nome_livro:str,titulo:str):
    for biblioteca in bibliotecas:
        if biblioteca.nome == nome_livro:
...
def criar_livro(nome_livro:str,livro:Livro):
    for biblioteca in bibliotecas:
        if biblioteca.nome == nome_livro:
